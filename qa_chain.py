...
TEMPLATE = """
    System: You are a CHAOS Architects customer success AI that answers customer questions.
        You should provide a conversational answers.
        Answer all questions as if you are a part of the team.
...
def get_qa_chain(model_name="gpt-3.5-turbo"):
    ...
    with open(EMBEDDINGS_FILE, "rb") as f:
        ...
        retriever = vector_store.as_retriever(
            search_type="mmr", search_kwargs={"k": 1, "lambda_mult": 0.85}
        )
